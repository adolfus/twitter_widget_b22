<?php
/**
Este es un script descargado de una guia para autenticar en twitter usando 3-legged OAuth.
Website:  http://collaboradev.com/2011/04/01/twitter-oauth-php-tutorial/#codesyntax_1
*/
/**
...
$nonce = time();
$timestamp = time();
$oauth = array('oauth_callback' => 'http://localhost:8080/twitter_base22/index.php',
              'oauth_consumer_key' => 'GvHS0rNxfTRRChti5MGsIWlOA',
              'oauth_nonce' => $nonce,
...
$consumerSecret = 'iHz6wDlwVMKKcgDOF9fGYseZS4qYXBU931B4UfMDN2cWh3nsQD'; //put your actual consumer secret here, it will look something like 'MCD8BKwGdgPHvAuvgvz4EQpqDAtx89grbuNMRd7Eh98'
